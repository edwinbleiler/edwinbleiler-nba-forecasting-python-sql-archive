...
TEAM_LOCATIONS = {
    ...
    1610612738: (42.3663, -71.0622),   # BOS
    1610612739: (41.4965, -81.6882),   # CLE
    1610612740: (29.9490, -90.0821),   # NOP
    1610612741: (41.8807, -87.6742),   # CHI
    1610612742: (32.7905, -96.8104),   # DAL
    1610612743: (39.7487, -104.9955),  # DEN
    1610612744: (37.7680, -122.3877),  # GSW
    1610612745: (29.7508, -95.3621),   # HOU
    1610612746: (38.8981, -77.0209),   # LAC
    1610612747: (34.0430, -118.2673),  # LAL
    1610612748: (25.7814, -80.1870),   # MIA
    1610612749: (43.0436, -87.9090),   # MIL
    1610612750: (44.9795, -93.2760),   # MIN
    1610612751: (40.6827, -73.9757),   # BKN
    1610612752: (40.7505, -73.9934),   # NYK
    1610612753: (28.5392, -81.3839),   # ORL
    1610612754: (39.7684, -86.1581),   # IND
    ...
    1610612759: (35.4634, -97.5151),   # OKC
    1610612760: (43.6435, -79.3791),   # TOR
    1610612761: (41.5047, -81.6814),   # CLE alt
    1610612762: (35.1382, -90.0506),   # MEM
    1610612763: (35.1382, -90.0506),   # MEM (dupe)
    1610612764: (38.8981, -77.0209),   # WAS
    1610612765: (42.3411, -83.0553),   # DET
    1610612766: (35.2271, -80.8431),   # CHA
    1610612769: (36.1745, -115.1372),  # LV (future)
}
...
def haversine(lat1, lon1, lat2, lon2):
    """Compute distance between two lat/lon coordinates."""
    R = 6371  # km
...
def build_features():
    ...
    def compute_travel(row):
        ...
        cur_lat, cur_lon = TEAM_LOCATIONS.get(row["team_id"], (0, 0))
        prev_lat, prev_lon = TEAM_LOCATIONS.get(row["team_id"], (0, 0))
